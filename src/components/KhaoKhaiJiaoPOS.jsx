...
export default function KhaoKhaiJiaoPOS() {
  ...
  const menuItems = [
    { id: 1, name: 'ข้าวไข่เจียวธรรมดา', price: 25, category: 'ข้าวไข่เจียว', image: '/images/omelet-normal.png', sales: 45 },
    { id: 2, name: 'ข้าวไข่เจียวหมูสับ', price: 30, category: 'ข้าวไข่เจียว', image: '/images/omelet-pork.png', sales: 38 },
    { id: 3, name: 'ข้าวไข่เจียวกุ้ง', price: 35, category: 'ข้าวไข่เจียว', image: '/images/omelet-shrimp.png', sales: 25 },
    { id: 4, name: 'ข้าวไข่เจียวปู', price: 50, category: 'ข้าวไข่เจียว', image: '/images/omelet-crab.png', sales: 15 },
    { id: 5, name: 'ข้าวไข่เจียวผักรวม', price: 35, category: 'ข้าวไข่เจียว', image: '/images/omelet-veggie.png', sales: 30 },
    { id: 6, name: 'ข้าวไข่เจียวพิเศษ', price: 60, category: 'ข้าวไข่เจียว', image: '/images/omelet-special.png', sales: 20 },
    ...
    { id: 11, name: 'ไข่เจียวเปล่า', price: 10, category: 'ของทานเล่น', image: '/images/snack-plain-omelet.png', sales: 18 },
    { id: 12, name: 'ไข่ดาว', price: 10, category: 'ของทานเล่น', image: '/images/snack-fried-egg.png', sales: 22 },
    { id: 13, name: 'ข้าวไข่เจียวชีส', price: 40, category: 'ข้าวไข่เจียว', image: '/images/omelet-cheese.png', sales: 12 },
    { id: 14, name: 'น้ำแตงโมปั่น', price: 30, category: 'เครื่องดื่ม', image: '/images/drink-watermelon.png', sales: 8 },
    { id: 15, name: 'ข้าวไข่เจียวแฮม', price: 40, category: 'ข้าวไข่เจียว', image: '/images/omelet-ham.png', sales: 6 },
